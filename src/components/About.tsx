    ...
    <section id="about" className="py-20 bg-gradient-card">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Founded in 1990 by Rajesh Mahi, our company began with a simple vision: to create 
        ...
        <div className="mt-20 text-center bg-tobacco-brown rounded-2xl p-12">
          ...
          <cite className="text-golden-amber font-semibold">- Rajesh Mahi, Founder & CEO</cite>
        </div>
      </div>
    </section>
  );
